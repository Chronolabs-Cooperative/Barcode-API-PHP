...
require_once __DIR . DS . 'Model' . DS . 'Cmyk.php';
require_once __DIR . DS . 'Model' . DS . 'Gray.php';
require_once __DIR . DS . 'Model' . DS . 'Hsl.php';
require_once __DIR . DS . 'Model' . DS . 'Rgb.php';
require_once __DIR . DS . 'Model' . DS . 'Template.php';
